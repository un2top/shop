                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tr>
                                    ...
                                    <td class="product-des product-name">
                                        <h5 class="product-name"><a href="product-details.html">J.Crew Mercantile Women's
                                                Short-Sleeve</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td class="product-des">
                                        <h5 class="product-name"><a href="product-details.html">Amazon Essentials Women's
                                                Tank</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td class="product-des">
                                        <h5 class="product-name"><a href="product-details.html">Amazon Brand - Daily Ritual
                                                Women's Jersey </a></h5>
                                            ...
                                            <div class="coupon">
                                                <form action="#" target="_blank">
                                                    <div class="form-row row justify-content-center">
                                                        ...
                                                        <div class="form-group col-lg-6">
                                                            <button class="btn  btn-sm"><i class="fi-rs-label mr-10"></i>Apply
                                                            </button>
                                                        </div>
                                                    </div>
                                                </form>
