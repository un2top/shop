                            ...
                            <div class="col-md-4">
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" id="dashboard-tab" data-bs-toggle="tab" href="#dashboard" role="tab" aria-controls="dashboard" aria-selected="false"><i class="fi-rs-settings-sliders mr-10"></i>Панель администратора</a>
                                        </li>
                                        <li class="nav-item">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        @foreach($orders as $order)
                                                            <tr>
                                                                ...
                                                                <td><a href="{{ route('admin.orderdetails', $order->id) }}" class="btn-small d-block">Просмотр</a></td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
