        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Редактировать категорию
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">Редактировать категорию</div>
                                    <div class="col-md-6"><a href="{{ route('admin.categories') }}" class="btn btn-success float-end">Категории</a> </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="updateCategory">
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="slug" class="form-label">Картинка</label>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <label for="is_popular" class="form-label">Популярное</label>
