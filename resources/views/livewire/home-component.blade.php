<div>
    <main class="main">
            ...
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    ...
                    <div class="banner-text d-md-block d-none">
                        ...
                        <a href="{{ route('shop') }}" class="btn">Узнать предложения<i class="fi-rs-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="{{ route('product.category', $pcategory->slug) }}"><img src="{{ asset('assets/imgs/categories') }}/{{ $pcategory->image }}" alt="{{ $pcategory->name }}" height="150"></a>
                            </figure>
                            <h5><a href="{{ route('product.category', $pcategory->slug) }}">{{ $pcategory->name }}</a></h5>
                        </div>
                        @endforeach
                    </div>
                </div>
        ...
        <section class="section-padding">
            <div class="container wow fadeIn animated">
                <h3 class="section-title mb-20"><span>Новые</span> поступления</h3>
                <div class="carausel-6-columns-cover position-relative">
