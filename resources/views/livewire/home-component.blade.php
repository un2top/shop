                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">Топ товаров
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two"
                                    type="button" role="tab" aria-controls="tab-two" aria-selected="false">Горячее предложение
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
...
{{--                                                <a href="{{ route('product.category', $fproduct->category->slug) }}">{{ $fproduct->category->name }}</a>--}}
{{--                                            </div>--}}
                                            <h2>
                                                <a href="{{ route('product.details', $fproduct->slug) }}">{{ $fproduct->name }}</a>
                                            </h2>
                                            <div>
                                                @if($fproduct->sale > 0)
                                                    <span>
                                            ...
                                            <div class="product-price">
                                                @if($fproduct->sale > 0)
                                                    <span>
                                                    ${{ $fproduct->sred_price*($fproduct->sale/100) }}
                                                </span>
                                                    <span class="old-price">
                                                    ${{ $fproduct->sred_price }}
                                                </span>
                                                @else
                                                    <span>${{ $fproduct->sred_price }} </span>
                                                @endif
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="В корзину" class="action-btn hover-up" href="#"
                                                   wire:click.prevent="store({{$fproduct->id}}, '{{ $fproduct->name }}', {{  $fproduct->sred_price*($fproduct->sale/100) }})"><i
...
{{--                                            </div>--}}
                                            ...
                                            <div class="product-price">
                                                @if($sproduct->sale > 0)
                                                    <span>
                                                    ${{ $sproduct->sred_price*($sproduct->sale/100) }}
                                                </span>
                                                    <span class="old-price">
                                                    ${{ $sproduct->sred_price }}
                                                </span>
                                                @else
                                                    <span>${{ $sproduct->sred_price }} </span>
                                                @endif
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="В корзину" class="action-btn hover-up" href="#"
                                                   wire:click.prevent="store({{$sproduct->id}}, '{{ $sproduct->name }}', {{ $sproduct->sred_price*($sproduct->sale/100) }})"><i
                                                        class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @foreach($latestProducts as $lproduct)
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
{{--                                            <div class="product-category">--}}
{{--                                                <a href="{{ route('product.category', $lproduct->category->slug) }}">{{ $lproduct->category->name }}</a>--}}
{{--                                            </div>--}}
                                            <h2>
                                                <a href="{{ route('product.details', $lproduct->slug) }}">{{ $lproduct->name }}</a>
                                            </h2>
                                            <div>
                                                @if($lproduct->sale > 0)
                                                    <span>
                                            ...
                                            <div class="product-price">
                                                @if($lproduct->sale > 0)
                                                    <span>
                                                    ${{ number_format($lproduct->sred_price*($lproduct->sale/100),1) }}
                                                </span>
                                                    <span class="old-price">
                                                    ${{ $lproduct->sred_price }}
                                                </span>
                                                @else
                                                    <span>${{ $lproduct->sred_price }} </span>
                                                @endif
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="В корзину" class="action-btn hover-up" href="#"
                                                   wire:click.prevent="store({{$lproduct->id}}, '{{ $lproduct->name }}', {{ number_format($lproduct->sred_price*($lproduct->sale/100),0) }})"><i
                                                        class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @foreach($limitedProducts as $limproduct)
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('product.details', $limproduct->slug) }}">
                                                    <img class="default-img"
...
{{--                                            </div>--}}
                                            <h2>
                                                <a href="{{ route('product.details', $limproduct->slug) }}">{{ $limproduct->name }}</a>
                                            </h2>
                                            <div>
                                            ...
                                            <div class="product-price">
                                                @if($limproduct->sale > 0)
                                                    <span>
                                                    ${{ $limproduct->sred_price*($limproduct->sale/100) }}
                                                </span>
                                                    <span class="old-price">
                                                    ${{ $limproduct->sred_price }}
                                                </span>
                                                @else
                                                    <span>${{ $limproduct->sred_price }} </span>
                                                @endif
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="В корзину" class="action-btn hover-up" href="#"
                                                   wire:click.prevent="store({{$limproduct->id}}, '{{ $limproduct->name }}', {{ $limproduct->sred_price*($limproduct->sale/100) }})"><i
                                                        class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
...
{{--                                        </div>--}}
                                        ...
                                        <div class="product-price">
                                            @if($oneLimitedProduct->sale > 0)
                                                <span>
                                                    ${{ $oneLimitedProduct->sred_price*($oneLimitedProduct->sale/100) }}
                                                </span>
                                                <span class="old-price">
                                                    ${{ $oneLimitedProduct->sred_price }}
                                                </span>
                                            @else
                                                <span>${{ $oneLimitedProduct->sred_price }} </span>
                                            @endif
                                        </div>
                                        <div class="product-action-1 show">
                                            <a aria-label="В корзину" class="action-btn hover-up" href="#"
                                               wire:click.prevent="store({{$oneLimitedProduct->id}}, '{{ $oneLimitedProduct->name }}', {{ $oneLimitedProduct->sred_price*($oneLimitedProduct->sale/100) }})"><i
                                                    class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                        <div>
                                                <span>
...
{{--                                        </div>--}}
                                        ...
                                        <div class="product-price">
                                            @if($vproduct->sale > 0)
                                                <span>
                                                    ${{ $vproduct->averageRegularPrice()*($vproduct->sale/100) }}
                                                </span>
                                                <span class="old-price">
                                                    ${{ $vproduct->averageRegularPrice() }}
                                                </span>
                                            @else
                                                <span>${{ $vproduct->averageRegularPrice() }} </span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
